...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/cluster/command-cluster': { kind: 'none', reason: 'The command reads the roster and the shared board in the command plane and writes nothing a model reads.' },
